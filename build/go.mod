...
require (
	github.com/harshit-splunk/k8sobjectreceiver v0.0.0
...
replace github.com/harshit-splunk/k8sobjectreceiver => /Users/hvaghani/go/src/github.com/harshit-splunk/k8sobjectreceiver
